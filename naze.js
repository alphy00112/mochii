...
const nyoutube = ('© MochiBot')  //ubah di config biar ngk emror
 ...
 // Akinator Setting Start
	...
	if (akinator.hasOwnProperty(m.sender.split('@')[0]) && isCmd && ["0", "1", "2", "3", "4", "5"].includes(body)) {
                ...
                if (get_result.hasOwnProperty("name")) {
                    ...
                    ini_txt += "*Sekian dan terima gaji. Akinator by MochiBot*"
	    ...
	    case 'family100': {
           ...
           case 'tebak': {
		    ...
		    delete caklontong_desk[m.sender.split('@')[0]]
                    ...
                    let anuw = await fetchJson('https://zenzapis.xyz/entertainment/asahotak?apikey=${apikeyz}')
				...
				if (tekateki.hasOwnProperty(m.sender.split('@')[0])) throw "Masih Ada Sesi Yang Belum Diselesaikan!"
                    let anuf = await fetchJson(`https://zenzapis.xyz/entertainment/tekateki?apikey=${apikeyz}`)
...
//PEMBATAS ADMIN & OWNER=======================================
 ...
 case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('https://wa.me/6281328433068')
            }
            break		 
            case 'subsyt': {
  ...
  naze.sendMessage(m.chat, buttonMessage, {quoted: fkontak})
            ...
            case 'setowner': {
               if (!isCreator) throw mess.owner
               if (m.text.includes('@')) return m.reply(`*Invalid!*\n\n*Pake Nomer Woy*\n*Jangan Pakai Tag!*`)
               if (!text) throw `Example : ${prefix + command} 6281328433068`
              global.owner = text
...
break
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6281328433068`
...
⭔ Detail: ${detail}`
		...
		if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')
            ...
            case 'webtonsearch': case 'webtoon': {
                ...
                get_result = await fetchJson(`https://zenzapis.xyz/webzone/webtoons?query=${kueri}&apikey=${apikeyz}`)
                get_result = get_result.result
...
let dana = `6281391317450@s.whatsapp.net`
...
break
 ...
 case 'art':
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let rb2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/mobil?apikey=${apikeyz}` },
                    caption: `Random Car`,
                    footer: `Random Car`,
                    buttons: rb1,
                    headerType: 4
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let rk2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/kucing?apikey=${apikeyz}` },
                    caption: `MEONG 🐱`,
                    footer: `Random Cat`,
                    buttons: rk1,
                    headerType: 4
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let ra2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/anjing?apikey=${apikeyz}` },
                    caption: `GUK GUK 🐶`,
                    footer: `Random Dog`,
                    buttons: ra1,
                    headerType: 4
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let rp2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/profil?apikey=${apikeyz}` },
                    caption: `PP Estetik`,
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let rv2 = {
                    image: { url: `https://zenzapis.xyz/randomanime/anime?apikey=${apikeyz}` },
                    caption: `Kawaii >//<`,
                    footer: `Random Anime`,
                    buttons: rv1,
                    headerType: 4
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let rt2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/motor?apikey=${apikeyz}` },
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let rs2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/boneka?apikey=${apikeyz}` },
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                ...
                let kp2 = {
                    image: { url: `https://zenzapis.xyz/randomimage/blackpink?apikey=${apikeyz}` },
                    caption: `Cantik :)`,
...
break
 ...
 // 4. Tambahan Menu
			...
			if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
             get_result = await fetchJson(`https://zenzapis.xyz/information/bmkg/gempa?apikey=${apikeyz}`)
			get_result = get_result.result
 ...
 // 5. Berita menu
	case 'tribunnews':
	if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
                    get_result = await fetchJson(`https://zenzapis.xyz/news/tribunews?apikey=${apikeyz}`)
                    get_result = get_result.result
                    ini_txt = "[ *TRIBUN NEWS* ]\n\n"
                    for (var x of get_result) {
	...
	case 'kompasnews':
	if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
					get_result = await fetchJson(`https://zenzapis.xyz/news/kompas?apikey=${apikeyz}`)
                    get_result = get_result.result
                    ini_txt = "[ *KOMPAS NEWS* ]\n\n"
                    for (var x of get_result) {
	...
	case 'detiknews':
	if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
					get_result = await fetchJson(`https://zenzapis.xyz/news/detiknews?apikey=${apikeyz}`)
                    get_result = get_result.result
                    ini_txt = "[ *DETIK NEWS* ]\n\n"
                    for (var x of get_result) {
                        ini_txt += `Judul : ${x.berita}\n`
	...
	case 'inews':
	if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
					get_result = await fetchJson(`https://zenzapis.xyz/news/inews?apikey=${apikeyz}`)
                    get_result = get_result.result
                    ini_txt = "[ *iNEWS NEWS* ]\n\n"
                    for (var x of get_result) {
                        ini_txt += `Judul : ${x.berita}\n`
	...
	case 'cnbcnews':
	if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
					get_result = await fetchJson(`https://zenzapis.xyz/news/cnbc?apikey=${apikeyz}`)
                    get_result = get_result.result
                    ini_txt = "[ *CNBC NEWS* ]\n\n"
                    for (var x of get_result) {
                        ini_txt += `Judul : ${x.berita}\n`
	...
	case 'okezone':
	if (!isRegistered) return m.reply('Kamu belum daftar! Silahkan daftar dengan cara #daftar nama|umur!')			
					get_result = await fetchJson(`https://zenzapis.xyz/news/okezone?apikey=${apikeyz}`)
                    get_result = get_result.result
